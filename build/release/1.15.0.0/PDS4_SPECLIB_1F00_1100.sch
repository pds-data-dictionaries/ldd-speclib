<?xml version="1.0" encoding="UTF-8"?>
  <!-- PDS4 Schematron for Name Space Id:speclib  Version:1.1.0.0 - Tue May 04 05:13:42 UTC 2021 -->
...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:rule context="speclib:Ancillary_Product_Internal_Reference/speclib:Ancillary_Product_reference_type">
      <sch:assert test=". = ('data_to_ancillary_data')">
        <title>speclib:Ancillary_Product_Internal_Reference/speclib:Ancillary_Product_reference_type/speclib:Ancillary_Product_reference_type</title>
        The attribute speclib:Ancillary_Product_reference_type must be equal to the value 'data_to_ancillary_data'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
    <sch:rule context="speclib:Measurement_Instrument_Internal_Reference/speclib:Measurement_Instrument_reference_type">
      <sch:assert test=". = ('measurement_parameters_to_instrument')">
        <title>speclib:Measurement_Instrument_Internal_Reference/speclib:Measurement_Instrument_reference_type/speclib:Measurement_Instrument_reference_type</title>
        The attribute speclib:Measurement_Instrument_reference_type must be equal to the value 'measurement_parameters_to_instrument'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
